...
def get_response(prompt):
    ...
    response = client.chat.completions.create(
        model="gpt-3.5-turbo",
       	messages=[
                 {"role": "system", "content": "You are an AI that only talks about teenage parenting. Do not respond to topics unrelated to teenege parenting. If asked about anything else, politely steer the conversation back to teenage parenting."},
                *st.session_state.messages,  # Keep chat history
